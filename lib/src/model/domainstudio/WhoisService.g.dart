...
part of 'WhoisService.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

WhoisService _$WhoisServiceFromJson(Map<String, dynamic> json) {
  return WhoisService(
    data: json['data'] == null
        ? null
        : WhoisServiceData.fromJson(json['data'] as Map<String, dynamic>),
...
Map<String, dynamic> _$WhoisServiceToJson(WhoisService instance) =>
    <String, dynamic>{
