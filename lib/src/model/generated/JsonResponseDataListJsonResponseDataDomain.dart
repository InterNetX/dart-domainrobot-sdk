...
/// The client transaction id for the response.
  ...
  ///
  factory JsonResponseDataListJsonResponseDataDomain.fromJson(Map<String, dynamic> json) =>
      _$JsonResponseDataListJsonResponseDataDomainFromJson(json);

  ///
  /// Location object to json
  ///
  Map<String, dynamic> toJson() => _$JsonResponseDataListJsonResponseDataDomainToJson(this);
