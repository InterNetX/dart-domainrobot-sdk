...
/// The client transaction id for the response.
  ...
  ///
  factory JsonResponseDataListJsonResponseDataObjectUserAssignment.fromJson(Map<String, dynamic> json) =>
      _$JsonResponseDataListJsonResponseDataObjectUserAssignmentFromJson(json);

  ///
  /// Location object to json
  ///
  Map<String, dynamic> toJson() => _$JsonResponseDataListJsonResponseDataObjectUserAssignmentToJson(this);
