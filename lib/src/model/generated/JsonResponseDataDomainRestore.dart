...
import 'DomainRestore.dart';
import 'Message.dart';
import 'ResponseObject.dart';
import 'ResponseStatus.dart';

part 'JsonResponseDataDomainRestore.g.dart';
...
/// The client transaction id for the response.
  ...
  ///
  factory JsonResponseDataDomainRestore.fromJson(Map<String, dynamic> json) =>
      _$JsonResponseDataDomainRestoreFromJson(json);

  ///
  /// Location object to json
  ///
  Map<String, dynamic> toJson() => _$JsonResponseDataDomainRestoreToJson(this);
