...
/// The template for objects to process
  ...
  ///
  factory BulkObjectUserAssignmentPatchRequest.fromJson(Map<String, dynamic> json) =>
      _$BulkObjectUserAssignmentPatchRequestFromJson(json);

  ///
  /// Location object to json
  ///
  Map<String, dynamic> toJson() => _$BulkObjectUserAssignmentPatchRequestToJson(this);
