...
part of 'JsonResponseDataPollMessage.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

JsonResponseDataPollMessage _$JsonResponseDataPollMessageFromJson(
    Map<String, dynamic> json) {
  return JsonResponseDataPollMessage(
    ...
    data: (json['data'] as List)
        ?.map((e) =>
            e == null ? null : PollMessage.fromJson(e as Map<String, dynamic>))
        ?.toList(),
