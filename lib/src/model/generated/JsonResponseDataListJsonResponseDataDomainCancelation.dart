...
/// The client transaction id for the response.
  ...
  ///
  factory JsonResponseDataListJsonResponseDataDomainCancelation.fromJson(Map<String, dynamic> json) =>
      _$JsonResponseDataListJsonResponseDataDomainCancelationFromJson(json);

  ///
  /// Location object to json
  ///
  Map<String, dynamic> toJson() => _$JsonResponseDataListJsonResponseDataDomainCancelationToJson(this);
