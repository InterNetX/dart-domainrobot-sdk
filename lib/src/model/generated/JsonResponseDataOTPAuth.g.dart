...
part of 'JsonResponseDataOTPAuth.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

JsonResponseDataOTPAuth _$JsonResponseDataOTPAuthFromJson(
    Map<String, dynamic> json) {
  return JsonResponseDataOTPAuth(
    ...
    data: (json['data'] as List)
        ?.map((e) =>
            e == null ? null : OTPAuth.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    ctid: json['ctid'] as String,
  );
}

Map<String, dynamic> _$JsonResponseDataOTPAuthToJson(
    JsonResponseDataOTPAuth instance) {
